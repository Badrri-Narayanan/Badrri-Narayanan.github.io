...
const compute_result_score = ()=>{
    if (User.innerHTML == Computer.innerHTML) Result.innerHTML = "It's a tie";
    else if (User.innerHTML == "Rock" && Computer.innerHTML == "Scissors" || User.innerHTML == "Paper" && Computer.innerHTML == "Rock" || User.innerHTML == "Scissors" && Computer.innerHTML == "Paper") {
...
//# sourceMappingURL=rock_paper_scissors.fa33fcc8.js.map
